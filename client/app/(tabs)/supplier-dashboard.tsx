...
import { Package, Truck, ShoppingCart, Clock, AlertTriangle, CheckCircle } from 'lucide-react-native';
...
export default function SupplierDashboardScreen() {
  ...
  const handleStatusPress = async (status: "pending" | "confirmed" | "shipped" | "delivered" | "cancelled" | "new" | "processing", orderId: string) => {
  ...
  const renderOrderCard = ({ item }: { item: Order }) => (
    ...
    >
      ...
      <View style={styles.actionButtons}>
        {item.status === 'new' && (
          <>
            <TouchableOpacity style={[styles.actionButton, styles.acceptButton]} onPress={() => handleStatusPress('confirmed', item._id)}>
              <Text style={styles.actionButtonText}>Accept</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.actionButton, styles.rejectButton]} onPress={() => handleStatusPress('cancelled', item._id)}>
        ...
        {item.status === 'processing' && (
          <TouchableOpacity style={[styles.actionButton, styles.shipButton]} onPress={() => handleStatusPress('shipped', item._id)}>
            <Text style={styles.actionButtonText}>Mark as Shipped</Text>
          </TouchableOpacity>
        )}
        
        {item.status === 'pending' && (
          <TouchableOpacity style={[styles.actionButton, styles.processButton]} onPress={() => handleStatusPress('processing', item._id)}>
