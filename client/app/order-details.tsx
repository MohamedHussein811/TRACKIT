...
export default function NewOrderScreen() {
  ...
  const [suppliers, setSuppliers] = useState<User[]>([]); // Mock suppliers data
  ...
  useEffect(() => {
    // Fetch suppliers from the API or use mock data
          ...
          {showSupplierDropdown && (
            <View style={styles.dropdownMenu}>
              {suppliers.map((supplier) => (
                ...
                >
                  <Text style={styles.dropdownItemText}>{supplier.name || supplier.email}</Text>
                </TouchableOpacity>
              ))}
            </View>
          )}
